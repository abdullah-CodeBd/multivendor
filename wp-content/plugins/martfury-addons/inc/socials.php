		...
		if ( $socials ) {
			if ( in_array( 'facebook', $socials ) ) {
				$socials_html .= sprintf(
					'<a class="share-facebook martfury-facebook" title="%s" href="http://www.facebook.com/sharer.php?u=%s&t=%s" target="%s"><i class="ion-social-facebook"></i></a>',
					esc_attr( $title ),
					urlencode( $link ),
					urlencode( $title ),
					esc_attr($target)
			...
			if ( in_array( 'twitter', $socials ) ) {
				$socials_html .= sprintf(
					'<a class="share-twitter martfury-twitter" href="http://twitter.com/share?text=%s&url=%s" title="%s" target="%s"><i class="ion-social-twitter"></i></a>',
					esc_attr( $title ),
					urlencode( $link ),
					urlencode( $title ),
					esc_attr($target)
			...
			if ( in_array( 'google', $socials ) ) {
				$socials_html .= sprintf(
					'<a class="share-google-plus martfury-google-plus" href="https://plus.google.com/share?url=%s&text=%s" title="%s" target="%s"><i class="ion-social-googleplus"></i></a>',
					urlencode( $link ),
					esc_attr( $title ),
					urlencode( $title ),
					esc_attr($target)
